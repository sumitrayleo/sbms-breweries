...
public class BeerController {
    ...
    @PostMapping
    public ResponseEntity handleNewBeer(@RequestBody BeerDto beer) {
    ...
    @PutMapping({"/{beerId}"})
    public ResponseEntity handleExistingBeer(@PathVariable("beerId") UUID beerId, @RequestBody BeerDto beer) {
